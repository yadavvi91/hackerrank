...
public class CoinChangeTest {
    ...
    private NumberOfWaysForCoinChange coinChange;
    ...
    public Object[] valueAndCoins() {
        return new Object[]{
                ...
                new Object[]{75L, new long[]{25, 10, 11, 29, 49, 31, 33, 39, 12, 36, 40, 22,
                        21, 16, 37, 8, 18, 4, 27, 17, 26, 32, 6, 38, 2, 30, 34}, 16694L},
                new Object[]{222L, new long[]{3, 25, 34, 38, 26, 42, 16, 10, 15, 50, 39, 44,
                        36, 29, 22, 43, 20, 27, 9, 30, 47, 13, 40, 33}, 5621927L},
        };
    }

    @Test
    @Parameters(method = "valueAndCoins")
    public void getWaysTestWithOnlyDP(long n, long[] c, long ways) throws Exception {
